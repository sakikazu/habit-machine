  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved record as @record" do
        ...
        post :create, {:record => { "habit_id" => "invalid value" }}, valid_session
        assigns(:record).should be_a_new(Record)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested record" do
        ...
        Record.any_instance.should_receive(:update_attributes).with({ "habit_id" => "1" })
        put :update, {:id => record.to_param, :record => { "habit_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the record as @record" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Record.any_instance.stub(:save).and_return(false)
        put :update, {:id => record.to_param, :record => { "habit_id" => "invalid value" }}, valid_session
        assigns(:record).should eq(record)
      end
