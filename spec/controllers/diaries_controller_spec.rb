  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved diary as @diary" do
        ...
        post :create, {:diary => { "title" => "invalid value" }}, valid_session
        assigns(:diary).should be_a_new(Diary)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested diary" do
        ...
        Diary.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => diary.to_param, :diary => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the diary as @diary" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Diary.any_instance.stub(:save).and_return(false)
        put :update, {:id => diary.to_param, :diary => { "title" => "invalid value" }}, valid_session
        assigns(:diary).should eq(diary)
      end
