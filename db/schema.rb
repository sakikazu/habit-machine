...
ActiveRecord::Schema.define(version: 2020_03_19_023819) do
  ...
  create_table "diaries", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "title"
    t.text "content"
    t.integer "user_id"
    t.date "record_at"
  ...
  create_table "habits", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "status"
    t.string "title"
    t.integer "user_id"
  ...
  create_table "senses", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "user_id"
    t.string "title"
    t.text "description"
    t.text "content"
